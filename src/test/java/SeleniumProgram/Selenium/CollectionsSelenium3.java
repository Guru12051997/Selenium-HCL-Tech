...
public class CollectionsSelenium3 {
	/*
	 * 1) Display books in sorted order(A-Z) using DropDown 2) Capture all the
	 * products in to a list (Original list) 3) Sort products ( using stream &
	 * lamda)then capture in to another list (Sorted list) 4) Compare Original list
	 * with Sorted list
	 */
